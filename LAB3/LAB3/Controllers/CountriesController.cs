    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var countries = await _context.Countries
                .FirstOrDefaultAsync(m => m.CN_ID == id);
            if (countries == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CN_ID,CN_NAME")] Countries countries)
        {
            if (id != countries.CN_ID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!CountriesExists(countries.CN_ID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Countries.Any(e => e.CN_ID == id);
        }
    }
}
